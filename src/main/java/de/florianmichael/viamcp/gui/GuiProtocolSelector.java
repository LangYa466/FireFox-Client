...
public class GuiProtocolSelector extends GuiScreen {
    ...
    class SlotList extends GuiSlot {
        ...
        @Override
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int mouseYIn, float partialTicks) {
            drawCenteredString(mc.fontRenderer,(ViaLoadingBase.PROTOCOLS.indexOf(ViaLoadingBase.getInstance().getTargetVersion()) == i ? TextFormatting.GREEN.toString() + TextFormatting.BOLD : TextFormatting.GRAY.toString()) + ViaLoadingBase.getProtocols().get(i).getName(), width / 2, i2 + 2, -1);
            GlStateManager.pushMatrix();
