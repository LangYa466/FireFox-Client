...
public class CFontRenderer extends FontRenderer {
    ...
    public CFontRenderer bold() {
        if (font.getStyle() == Font.BOLD) return this;
        return FontManager.getRenderer(font.deriveFont(Font.BOLD), size);
    }
    ...
    public final int drawStringWithShadow(String text, float x, float y, int rgb) {
        drawString(text, x + 0.5f, y + 0.5f, rgb, true);
        return drawString(text, x, y, rgb);
    }
