...
import cn.firefox.util.render.shader.FileUtil;
...
public class NetworkingUtil implements Wrapper {
    ...
    public static HttpResponse httpsConnection(String url) {
        ...
        try {
            ...
            connection.connect();
            return new HttpResponse(FileUtil.readInputStream(connection.getInputStream()), connection.getResponseCode());
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static HttpResponse httpConnection(String url) {
        try {
            ...
            connection.setRequestProperty("User-Agent", USER_AGENT);
            connection.connect();
            return new HttpResponse(FileUtil.readInputStream(connection.getErrorStream()), connection.getResponseCode());
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
