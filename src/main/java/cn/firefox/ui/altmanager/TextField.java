...
import static cn.firefox.ui.altmanager.misc.Screen.iconFont16;
...
public class TextField extends Gui {
    ...
    public TextField(CFontRenderer font) {
        this.font = font;
    }

    public TextField(CFontRenderer font, float x, float y, float par5Width, float par6Height) {
        this.font = font;
        this.xPosition = x;
        this.yPosition = y;
        ...
        if (this.getVisible()) {
            ...
            if (backgroundText != null) {
                ...
                if (backgroundText.equals("Search")) {
                    iconFont16.drawString(IconUtil.SEARCH, xPos + 1.5f, this.yPosition + iconFont16.getMiddleOfBox(getHeight()), ColorUtil.applyOpacity(unfocusedTextColor, textAlpha));
                    xPos += 15;
                }
