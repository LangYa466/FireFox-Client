        ...
        if (cansetvalue) {
            ...
            for (Value<?> value : m.getValues()) {
                ...
                if (value instanceof BooleanValue booleanValue) {
                    ...
                    if (booleanValue.getValue())
                        FontManager.font(14).drawString("v",(float) (1f + x + FontManager.font(14).getStringWidth(booleanValue.getName()) + ((14.5f) * (1 + booleanValue.easeBackIn.getOutput()))), y + (float) height / 2 - (float) FontManager.font(14).getHeight() / 2 + 18.5f + moduley + FontManager.font(14).getHeight() + 8 + numberindex * 15 + addition - FontManager.font(14).getHeight() + 10, ColorUtil.applyOpacity(new Color(-1), (float) booleanValue.decelerateAnimation.getOutput()).getRGB());
