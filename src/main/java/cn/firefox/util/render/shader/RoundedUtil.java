...
public class RoundedUtil {
    ...
    public static void drawGradientRound(float x, float y, float width, float height, float radius, Color leftCOlor, Color rightColor) {
        drawGradientRound(x,y,width,height,radius,leftCOlor,leftCOlor,rightColor,rightColor);
    }
