...
public class ShaderUtil implements Wrapper {
    ...
    public ShaderUtil(String fragmentShaderLoc, String vertexShaderLoc) {
        ...
        try {
            int fragmentShaderID = switch (fragmentShaderLoc) {
                ...
                case "gradientround" ->
                        createShader(new ByteArrayInputStream(gradientround.getBytes()), GL_FRAGMENT_SHADER);
                case "gradient" -> createShader(new ByteArrayInputStream(gradient.getBytes()), GL_FRAGMENT_SHADER);
                case "clickgui" -> createShader(new ByteArrayInputStream(clickgui.getBytes()), GL_FRAGMENT_SHADER);
                case "roundedRect" ->
                ...
                case "arc" -> createShader(new ByteArrayInputStream(arc.getBytes()), GL_FRAGMENT_SHADER);
    ...
    public ShaderUtil(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("m0ssh3ck/shader/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "m0ssh3ck/shader/vertex.vsh");
    }
